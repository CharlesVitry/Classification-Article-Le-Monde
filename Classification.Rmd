---
title: |
  ![](images/RStudio_Logo.png){width=125%}  
...
Avec ni gestion des manquants, ni gestion des fautes d'orthographes/gestion de mots anglais à réaliser (puisqu'il s'agit d'articles de presse).
...
![CrossValidation.png](images/CrossValidation.png){width=50%}
...
Le choix de la metric "Accuracy" pour l'optimisation de nos modèles a été arbitraire et sera questionné lors de nos prochains projets.
